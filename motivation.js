document.addEventListener('DOMContentLoaded', function() {
    fetchTopMotivationalBooks();
});

function fetchTopMotivationalBooks() {
    fetch('https://www.googleapis.com/books/v1/volumes?q=motivation&maxResults=15&orderBy=relevance')
